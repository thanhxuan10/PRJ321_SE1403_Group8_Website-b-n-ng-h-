        ...
        <%
            if (request.getParameter("logout") != null) {
                ...
                for (Cookie cookie : cookies) {
                    ...
                    if (cookieName.equals("user") || cookieName.equals("pass")) {
                        cookie.setMaxAge(0);
			...
			<div class="card-body">
				<form action="LoginControllers" method="post">
					...
					<div class="form-group">
                                                <input type="submit" name="Login_user" value="Login user" class="btn float-right login_btn"/>
						<input type="submit"  name="Login_admin" value="Login admin" class="btn float-left login_btn"/>
					</div>
				</form>
			</div>
			<div class="card-footer">
				<div class="d-flex justify-content-center links">
					Don't have an account?<a href='./User/register.jsp'>Sign Up</a>
				</div>
