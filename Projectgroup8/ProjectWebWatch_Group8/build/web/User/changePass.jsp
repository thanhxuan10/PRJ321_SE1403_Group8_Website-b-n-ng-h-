                    ...
                    <div class="card-body">
                        <form action="../ChangePassController" method="post">
                            ...
                            <div class="input-group form-group">
                                ...
                                <input type="password" class="form-control" placeholder="Enter confirm password" name="apass">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="submit"  name="change" value="Submit" class="btn float-center login_btn" style="width: 100%"/>
                            </div>
                        </form>
                    </div>
